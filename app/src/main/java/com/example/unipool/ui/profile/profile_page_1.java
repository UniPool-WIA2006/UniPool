...
public class profile_page_1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_profile_page_1, container, false);
        ...
        Btn_RegAsDriver = getView().findViewById(R.id.Btn_RegAsDriver);
        ...
        changeProfile = getView().findViewById(R.id.changeProfile);
    ...
    //This code will executed when the user come back from other page.
    //Hence, the profile page will keep updated as long as user make a change.
    @Override
    public void onStart() {
        super.onStart();
        dbHandler = new DatabaseHandler(getActivity());
        ...
        Btn_EditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("username", username);
                fragment.setArguments(bundle);
                Navigation.findNavController(view).navigate(R.id.action_profile_page_1_to_edit_profile);
            }
        });
